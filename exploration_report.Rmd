...
**UPDATE:** The final word predictor uses up to tetragrams. Besides the back-off strategies described above, it attempts to correct spellings and phrases before "giving up". Additionally, it offers suggestions to complete, or correct, the word being typed (i.e. the current word). Links to the final project will be uploaded soon. 
